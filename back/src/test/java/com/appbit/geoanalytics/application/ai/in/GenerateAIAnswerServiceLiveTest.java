...
class GenerateAIAnswerServiceLiveTest {
    ...
    @Test
    void returnsValidResponseWithSufficientEvidenceEs() {
        Assumptions.assumeTrue(isGeminiAvailable(), "Gemini API key not configured");
    ...
    @Test
    void returnsValidResponseWithSufficientEvidenceEn() {
        Assumptions.assumeTrue(isGeminiAvailable(), "Gemini API key not configured");
    ...
    @Test
    void returnsValidResponseWithSufficientEvidencePt() {
        Assumptions.assumeTrue(isGeminiAvailable(), "Gemini API key not configured");
